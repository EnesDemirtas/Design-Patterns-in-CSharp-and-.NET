...
// As you know, a bool is not kept as a bit, it is kept as a byte(s). Memory issues.
// This example demonstrates how to work with bits for a mathematical problem

    public class TwoBitSet {
        // 64 bits --> reducing 32 values, two bit pairs. Therefore, there is 4 different possibilities, 00 01 10 11
        ...
        // 1010101010 00 10 01 01 from right to left, index 0 1 2 ...
        public byte this[int index] {
            get {
                // 00 10 01 01

                var shift = index << 1; // multiply by 2 to get the correct pair
                ulong mask = (0b11U << shift); // make the rest 00, 00 11 00 00
                // 00 10 00 00 >> shift
                // 00 00 00 10
    ...
    public static class OpImpl {
        ...
        private static readonly Dictionary<Op, char> opNames = new();
    ...
    public class Problem {
        // 1 3 5 7
        // Op.Add Op.Mul Op.Add, Mul has priority
