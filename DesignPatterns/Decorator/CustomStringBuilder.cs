...
// Original string builder is sealed, we cannot inherit from it
// This demo shows how to build a decorator over a single class
public class CustomStringBuilder {
    public class CodeBuilder {
        private StringBuilder _builder = new();
        // after create a new StringBuilder, generate all delegating members 
        // Replace the StringBuilder word to CodeBuilder, 
        // Replace return _builder.(.+)$ to _builder.$1\nreturn this;
        // Fix the errors, e.g. instead of return this, just return the code directly
